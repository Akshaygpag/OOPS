...
public class StockTrading {
	...
	for (int i = 0; i < allStocks.length; i++) {
	    ...
	    System.out.print(String.format("%-20s %-20s %20s", stockData));

	    System.out.print(" "+decimalFormat.getCurrency());
	    System.out.println();
	}
	System.out.println("-------------------------------------------------------------------");
	...
	System.out.println(String.format("%-20s  %40s", stockDataHeaders));
